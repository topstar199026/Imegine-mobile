...
const NewChatGroup = () => {
    ...
    const makeGroupContactList = () => {
        ...
        var _groupContactList = keys.map((_key, i) => {
                ...
                for(var i = 0; i < contactListTemp.fRows.length; i++) {
                    ...
                    _temp.push(
                        // @ts-ignore
                        {
                            ...
                            selected: checkSelected(contactListTemp.fRows[i]),
                        }
                    );
                }
    ...
    const getContactList = () => {
        ContactActions.getContactList(rsa, {
            flag: true,
    ...
    const handleTypeActive = (s) => {
        navigation.navigate('NewChatGroupSave', {
